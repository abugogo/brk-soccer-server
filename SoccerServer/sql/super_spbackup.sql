...
--
-- Dumping routines for database 'abugogo_acc_super'
--
...
FROM
    ...
    FROM
        abugogo_acc_super.lineup LNP
    INNER JOIN abugogo_acc_super.games_tbl GMS ON LNP.game_id = GMS.game_id
    WHERE
    ...
    FROM
        abugogo_acc_super.lineup_events
    WHERE
...
-- Dump completed on 2013-02-05 23:06:47
