...
--
-- Dumping routines for database 'abugogo_acc_winn'
--
...
FROM
    ...
    FROM
        abugogo_acc_winn.lineup LNP
    INNER JOIN abugogo_acc_winn.games_tbl GMS ON LNP.game_id = GMS.game_id
    WHERE
    ...
    FROM
        abugogo_acc_winn.lineup_events
    WHERE
...
-- Dump completed on 2013-02-05 23:07:05
